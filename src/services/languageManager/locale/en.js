export default {
  ...
  SIGNUP_DESCRIPTION: "Signup new account to have your space",
  ...
  SIGNUUP_SUCCESS_CONTENT_TITLE: "SIGN UP SUCCESS",
  SIGNUUP_SUCCESS_CONTENT_MSG:
    "Welcome to CAASER. Your account created successfully. Back to Login page and start editing your project.",
  // FORGOT PASS
  FORGOT_PASS_EMAIL_TITLE: "WELCOME",
  ...
  FORGOT_PASS_CONTENT_CODE_PLACEHOLDER: "*****",
  DONE: "DONE",
  ...
  CHANGE_PASS_SUCCESS_CONTENT_MSG:
    "Your new password changed successfuly.you can login by new password again.",
  CONFIRM_EMAIL_TITLE: "WELCOME",
  CONFIMR_EMAIL_DESCRIPTION: "Email Confirmation to start on the space",
