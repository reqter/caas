export default {
  ...
  // login
  LOGIN_TITLE: "WELCOME TO REQTER",
  LOGIN_DESCRIPTION:
    "From massive amounts of content scattered across multiple CMSes, to a single source of truth. Unified content anywhere",
  LOGIN_CONTENT_TITLE: "Sign in to your account",
  LOGIN_CONTENT_DESC: "Enter your detail",
  LOGIN_EMAIL_INPUT_TITLE: "Email Address",
  LOGIN_EMAIL_INPUT_PLACEHOLDER: "example@mail.com",
  LOGIN_PASSWORD_INPUT: "Enter Password",
  ...
  // SIGNUP
  SIGNUP_TITLE: "Signup and enter to Reqter's world",
  SIGNUP_EMAIL_INPUT_TITLE: "Email Address",
  SIGNUP_EMAIL_INPUT_PLACEHOLDER: "Enter your email",
  SIGNUP_DESCRIPTION:
  ...
  SIGNUP_CONTENT_TITLE: "Sign Up New Account",
  SIGNUO_SUBMIT_BTN_TEXT: "Sign up",
  SIGNUP_PASSWORD_INPUT: "Enter Password",
  SIGNUP_PASSWORD_INPUT_PLACEHOLDER: "Enter your password",
  SIGNUP_CONFIRM_PASSWORD_INPUT: "Confirm password",
  SIGNUP_CONFIRM_PASSWORD_INPUT_PLACEHOLDER: "Enter password",
  SIGNUP_SUCCESS_TITLE: "WELCOME",
  SIGNUP_SUCCESS_DESCRIPTION: "You registered successfully",
  SIGNUUP_SUCCESS_CONTENT_BTN: "Login and start",
  LOGIN: "Login",
  ...
  SIGNUUP_SUCCESS_CONTENT_TITLE: "You registered successfully.",
  SIGNUUP_SUCCESS_CONTENT_MSG:
    "Welcome to Reqter. Your account created successfully. Back to Login page and start editing your project.",
  // FORGOT PASS
  FORGOT_PASS_INFO_TITLE: "Get your password easily",
  FORGOT_PASS_INFO_DESC:
    "Reqter will ask you some information to get back your password. Try to do steps carefully",
  FORGOT_PASS_EMAIL_TITLE: "",
  FORGOT_PASS_CODE_TITLE: "WELCOME",
  FORGOT_PASS_CHANGE_TITLE: "WELCOME",
  FORGOT_PASS_SUCCESS_TITLE: "WELCOME",
  FORGOT_PASS_EMAIL_DESC:
    "Enter your email to get back a code to set new password",
  FORGOT_PASS_CODE_DESC: "We just sent a code to your email. Please enter that",
  FORGOT_PASS_CHANGE_DESC:
    "Enter new password at least 6 characters combination of upper- and lower-case characters(*)",
  FORGOT_PASS_SUCCESS_DESC:
    "Enter your email to get back a code to set new password",
  FORGOT_PASS_CONTENT_TITLE: "Getting Password",
  FORGOT_PASS_TITLE: "Getting Password",
  EMAIL_ADDRESS: "Email Address",
  EMAIL_ADDRESS_PLACEHOLDER: "example@mail.com",
  SEND_CODE: "SEND CODE",
  FORGOT_PASS_CONTENT_CODE_INPUT: "Enter The Code",
  FORGOT_PASS_CONTENT_CODE_PLACEHOLDER: "Enter the code",
  DONE: "DONE",
  FORGOT_PASS_CONTENT_CHANGE_TITLE: "Change Password",
  NEW_PASS_INPUT: "Enter New Password",
  CONFIRM_PASS_INPUT: "Confirm New Password",
  NEW_PASS_PLACEHOLDER: "******",
  CONFIRM_PASS_PLACEHOLDER: "******",
  RESET_PASSWORD: "RESET PASSWORD",
  CHANGE_PASS_SUCCESS_CONTENT_TITLE: "PASSWORD CHANGED",
  CHANGE_PASS_SUCCESS_CONTENT_MSG:
    "Your new password changed successfully so back to login page and do it with your new password",
  CONFIRM_EMAIL_TITLE: "Confirming your email",
  CONFIRM_EMAIL_DESCRIPTION: "To some operations in Reqter you must confirm your email to go forward",
  CONFIRM_EMAIL_CONTENT_TITLE: "Email Confirmed",
  CONFIRM_EMAIL_CONTENT_MSG:
    "Your email confirmed successfuly. Back to login to start working on your space",
  ...
  HOME_SIDE_NAV_HOME_DESC: "Review like a dashboard",
  ...
  HOME_SIDE_NAV_CONTENTS: "Contents",
  HOME_SIDE_NAV_CONTENTS_DESC: "Define and manage your content",
  HOME_SIDE_NAV_REQUESTS: "Content Requests",
  ...
  SUCCESS_TEXT: "Actions was done successfully.",
