...
const baseUrl = config.REACT_APP_ACCOUNT_BASE_URL;
const login_url = baseUrl + config.REACT_APP_ACCOUNT_LOGIN_URL;
const signup_url = baseUrl + config.REACT_APP_ACCOUNT_SIGNUP_URL;
...
const changeAvatarURL = baseUrl + config.REACT_APP_ACCOUNT_CHANGE_AVATAR;
const changePasswrodURL = baseUrl + config.REACT_APP_ACCOUNT_CHANGE_PASSWORD;
const changeNotificationURL =
  baseUrl + config.REACT_APP_ACCOUNT_CHANGE_NOTIFICATION;
const deleteAccountURL = baseUrl + config.REACT_APP_ACCOUNT_DELETE_ACCOUNT;
...
export function verifyCode() {
  ...
  const _call = async (username, code) => {
    try {
      const url = verifyCode_url;
      var rawResponse = await fetch(url, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json"
...
export function resetPassword() {
  ...
  const _call = async (token, newpassword) => {
    try {
...
export function confirmEmailFromURL() {
  let _onOkCallBack;
  function _onOk(result) {
    if (_onOkCallBack) {
      _onOkCallBack(result);
